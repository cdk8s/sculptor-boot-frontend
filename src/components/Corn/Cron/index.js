...
class CRON extends React.Component {
  ...
  onSecondRadioChange = (e) => {
    ...
    switch (SecondRadiochecked) {
      case 1:
        this.changeState({ secondVal: '*' });
        break;
      case 2:
        this.changeState({ secondVal: `${this.state.secondCycleStart}-${this.state.secondCycleEnd}` });
        break;
      case 3:
        this.changeState({ secondVal: `${this.state.secondStart}/${this.state.secondEvery}` });
        break;
      case 4:
        this.changeState({ secondVal: this.state.secondChecked });
        break;
    }
  };
  ...
  onMinuteRadioChange = (e) => {
    ...
    switch (minuteRadiochecked) {
      case 1:
        this.changeState({ minVal: '*' });
        break;
      case 2:
        this.changeState({ minVal: `${this.state.minuteCycleStart}-${this.state.minuteCycleEnd}` });
        break;
      case 3:
        this.changeState({ minVal: `${this.state.minuteStart}/${this.state.minuteEvery}` });
        break;
      case 4:
        this.changeState({ minVal: this.state.minuteChecked });
        break;
    }
  };
  ...
  onMinuteCheckChange = (checkedValues) => {
    ...
    if (this.state.minuteRadiochecked === 4) {
      this.changeState({ minVal: minuteChecked });
    }
  };
  // ---------------------------------------分-------------------------------------------------------------------------------------
  ...
  onHourRadioChange = (e) => {
    ...
    switch (hourRadiochecked) {
      case 1:
        this.changeState({ hourVal: '*' });
        break;
      case 2:
        this.changeState({ hourVal: `${this.state.hourCycleStart}-${this.state.hourCycleEnd}` });
        break;
      case 3:
        this.changeState({ hourVal: `${this.state.hourStart}/${this.state.hourEvery}` });
        break;
      case 4:
        this.changeState({ hourVal: this.state.hourChecked });
        break;
    }
  };
  ...
  onHourCheckChange = (checkedValues) => {
    ...
    if (this.state.hourRadiochecked + '' === '4') {
      this.changeState({ hourVal: hourChecked });
    }
  };
  // ---------------------------------------时-------------------------------------------------------------------------------------
  ...
  onDaysRadioChange = (e) => {
    ...
    switch (daysRadiochecked) {
      case 1:
        this.changeState({ dayOfMonVal: '*' });
        break;
      case 2:
        this.changeState({ dayOfMonVal: '?' });
        break;
      case 3:
        this.changeState({ dayOfMonVal: `${this.state.daysCycleStart}-${this.state.daysCycleEnd}` });
        break;
      case 4:
        this.changeState({ dayOfMonVal: `${this.state.daysStart}/${this.state.daysEvery}` });
        break;
      case 5:
        this.changeState({ dayOfMonVal: `${this.state.daysForWorking}W` });
        break;
      case 6:
        this.changeState({ dayOfMonVal: 'L' });
        break;
      case 7:
        this.changeState({ dayOfMonVal: this.state.daysChecked });
        break;
    }
  };
  ...
  onDaysCheckChange = (checkedValues) => {
    ...
    if (this.state.daysRadiochecked + '' === '7') {
      this.changeState({ dayOfMonVal: daysChecked });
    }
  };
  // ---------------------------------------日-------------------------------------------------------------------------------------
  ...
  onMonthRadioChange = (e) => {
    ...
    switch (monthRadiochecked) {
      case 1:
        this.changeState({ MonVal: '*' });
        break;
      // case 2: this.changeState({ MonVal: '?' }); break;
      case 3:
        this.changeState({ MonVal: `${this.state.monthCycleStart}-${this.state.monthCycleEnd}` });
        break;
      case 4:
        this.changeState({ MonVal: `${this.state.monthStart}/${this.state.monthEvery}` });
        break;
      case 5:
        this.changeState({ MonVal: this.state.monthChecked });
        break;
    }
  };
  ...
  onMonthCheckChange = (checkedValues) => {
    ...
    if (this.state.monthRadiochecked === 5) {
      this.changeState({ MonVal: monthChecked });
    }
  };
  ...
  onWeekRadioChange = (e) => {
    ...
    switch (weekRadiochecked) {
      case 1:
        this.changeState({ dayOfWekVal: '*' });
        break;
      case 2:
        this.changeState({ dayOfWekVal: '?' });
        break;
      case 3:
        this.changeState({ dayOfWekVal: `${this.state.weekCycleStart}-${this.state.weekCycleEnd}` });
        break;
      case 4:
        this.changeState({ dayOfWekVal: `${this.state.weekEvery}#${this.state.weekStart}` });
        break;
      case 5:
        this.changeState({ dayOfWekVal: `${this.state.weekEnd}L` });
        break;
      case 6:
        this.changeState({ dayOfWekVal: this.state.weekChecked });
        break;
    }
  };
  ...
  onWeekCheckChange = (checkedValues) => {
    ...
    if (this.state.weekRadiochecked === 6) {
      this.changeState({ dayOfWekVal: weekChecked });
    }
  };
  ...
  onYearRadioChange = (e) => {
    ...
    switch (yearRadiochecked) {
      ...
      case 2:
        ...
        break;
      case 3:
        this.setState({ yearVal: `${this.state.yearCycleStart}-${this.state.yearCycleEnd}` });
        break;
    }
    if (yearRadiochecked + '' !== '2') {
      const { secondVal, minVal, hourVal, dayOfMonVal, MonVal, dayOfWekVal } = this.state;
      if (secondVal + '' === '*') {
        this.setState({ secondVal: '0' });
      }
      if (minVal + '' === '*') {
      ...
      if (dayOfMonVal + '' === '*') {
        this.setState({ dayOfMonVal: '0' });
      }
      if (MonVal + '' === '*') {
        this.setState({ MonVal: '0' });
      }
      if (dayOfWekVal + '' === '*') {
        this.setState({ dayOfWekVal: '?' });
      }
    }
  };
