...
import { Input, Modal, Row, Col, Icon } from 'antd';
import './index.less';
...
class Index extends Component<any, any> {
  ...
  itemChange = (item: any) => {
    this.setState({ value: item, visible: false });
    ...
    return (
      <div>
        <Input
          ...
          suffix={<Icon type={this.state.value}/>}
          addonAfter={(
            <span style={(this.props.attribute && this.props.attribute.disabled) ? styles.disabled : styles.default} onClick={() => {
              if (this.props.attribute && this.props.attribute.disabled) return;
        ...
        >
          <Row>
            {
              this.state.iconData.map((item: any) => {
                return (
                  <Col span={4} onClick={() => this.itemChange(item)}>
                    <div className='col-style'>
                      <div>
                        <Icon className='fs32' type={item}/>
                        <h6>{item}</h6>
                      </div>
                    </div>
                  </Col>
